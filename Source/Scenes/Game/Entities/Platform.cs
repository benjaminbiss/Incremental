...
public partial class Platform : Sprite2D
{
    ...
    private Dictionary<E_PlatformTypes, Rect2> atlasRegions = new Dictionary<E_PlatformTypes, Rect2>
    {
    ...
    private E_PlatformTypes platformType;
    [Export]
    public E_PlatformTypes PlatformType
    {
        get { return platformType; }
        set { SetPlatformType(value); }
    }
  
    private void SetPlatformType(E_PlatformTypes newType)
    {
        platformType = newType;
        if (atlasRegions.ContainsKey(platformType))
        {
            RegionRect = atlasRegions[platformType];
        }
        else
        {
